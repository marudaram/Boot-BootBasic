...
public class ValidVO {
	 ...
	 * @Pattern - 정규표현식에 맞는 문자열을 직접 정의할 수 있음 (String에만 적용)
	 * @Email - 이메일형식 검증, 단 공백은 통과
	 * @Min - 최소값
	 * @Max - 최대값
	 */
	...
	//숫자, 실수형의 원시타입은 기본값이 0이라서 공백맵핑이 불가능하기 때문에 래퍼타입으로 선언하는 편이 좋다
	...
	@NotBlank //이메일 어노테이션은 공백을 통과하기 때문에 동시에 적용해준다
	@Email(message = "email형식이어야 합니다~")
